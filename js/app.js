(() => {
    ...
    function initSliders() {
        if (document.querySelector(".extend__slider")) new core(".extend__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 800,
            navigation: {
                prevEl: ".slide-extend__arrow-left.swiper-button-prev",
                nextEl: ".slide-extend__arrow-right.swiper-button-next"
            },
            on: {}
        });
    }
